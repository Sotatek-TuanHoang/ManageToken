...
web3.setProvider(new Web3.providers.HttpProvider('https://rinkeby.infura.io/v3/18755d6eac1049be93703afd1e38085e'));
...
const zAddress = '0x8080C7e4B81ecf23aa6F877cfbfD9b0C228C6ffA';

const contractZrx = new web3.eth.Contract(abi, zAddress);
const getTotalSupply = async () => {
    return await contractZrx.methods.totalSupply().call();
}
